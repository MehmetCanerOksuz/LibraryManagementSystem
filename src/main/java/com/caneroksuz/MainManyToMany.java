...
import com.caneroksuz.controller.AddressController;
import com.caneroksuz.controller.UserInformationController;
...
public class MainManyToMany {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        UserInformation userInformation1 = UserInformation.builder().firstName("Caner")
                .address(Set.of(address1,address2)).build();
        UserInformation userInformation2 = UserInformation.builder().firstName("Mustafa")
                .address(Set.of(address1,address2)).build();
